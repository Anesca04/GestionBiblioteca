...
public class Cliente extends Usuario {
     ...
     */
    public Cliente(String nombre, String dni, int edad, String numTelefono){
     ...
     * @param numTelefono Número de teléfono del cliente
     */
    public Cliente(String nombre, String dni, int edad, ArrayList<Libro> librosPrestados, String numTelefono) {
        super(nombre, dni, edad);
