...
public class Biblioteca {
     ...
     */
    public Cliente clienteAPartirDNI(String dni) throws DNIInvalidoException{
        
        if (!Biblioteca.dniValido(dni)){
            throw new DNIInvalidoException("El DNI introducido no es correcto");
        }
    ...
    public Bibliotecario bibliotecarioAPartirDNI(String dni) throws DNIInvalidoException{
