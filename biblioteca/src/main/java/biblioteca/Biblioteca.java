...
public class Biblioteca {
    ...
    public Prestamo getPrestamo(Cliente c, Libro l){
        for (Prestamo p : prestamos){
            if (p.getCliente().getDni().equals(c.getDni()) && p.getLibro() == l){
                return p;
            }
        }
    ...
    public void crearCliente(String nombre, String dni, int edad, String numTelefono) throws DNIInvalidoException, EdadInvalidaException, TelefonoInvalidoException{
        Cliente aux = new Cliente(nombre, dni, edad, numTelefono);
        ...
        columnasUsuario.put("telefono", numTelefono);
        try{
    ...
    public void editarCliente(String dni, String nombre, int edad, String telefono) throws DNIInvalidoException, TelefonoInvalidoException, EdadInvalidaException{
     ...
     */
    public void rellenarAPartirDeBD() throws DNIInvalidoException, TelefonoInvalidoException, EdadInvalidaException{
        try{
            clientes = DAO.consultarClientes();
