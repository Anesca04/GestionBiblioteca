...
public class Escritor extends Usuario {
     ...
     */
    public Escritor(String nombre, String dni, int edad, String idioma) throws DNIInvalidoException{
     ...
     * @param idioma Idioma del escritor
     */
    public Escritor(String nombre, String dni, int edad, ArrayList<Libro> librosPublicados, String idioma) {
        super(nombre, dni, edad);
