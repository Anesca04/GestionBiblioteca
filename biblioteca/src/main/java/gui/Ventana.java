...
public class Ventana extends JFrame {
	...
	public Ventana() {
            ...
            try{
                ...
                System.out.println("Error. Formato de DNI incorrecto encontrado al rellenar la biblioteca");
            }
            catch(TelefonoInvalidoException e){
                System.out.println("Error. Telefono incorrecto encontrado al rellenar la biblioteca");
            }
            catch(EdadInvalidaException e){
                System.out.println("Error. Edad incorrecta encontrada al rellenar la biblioteca");
            }
            cliente = null;
            bibliotecario = null;
