...
public class Cliente extends Usuario {
     ...
     */
    public Cliente(String nombre, String dni, int edad, int idCliente, String numTelefono) {
     ...
     * @param numTelefono Número de teléfono del cliente
     */
    public Cliente(String nombre, String dni, int edad, int idCliente, ArrayList<Libro> librosPrestados, String numTelefono) {
        super(nombre, dni, edad);
        this.idCliente = idCliente;
